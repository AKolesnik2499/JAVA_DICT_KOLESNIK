...
public class matrix {
    public static void main(String[] args) {
        ...
        while(true){
            ...
            try{
                switch(choice){
                    case 2:
                        MethodAdd(rows, columns);
                        break;
                    case 3:
                        MethodMultiply(rows, columns);
                        break;
                    case 4:
                        MethodMultiplyMatrix(rows, columns);
                        break;
                    case 5:
                        MethodTranspose(rows, columns);
                        break;
                    case 6:
                        MethodDeterminant(rows, columns);
                        break;
                    case 7:
                        MethodInverseMatrix(rows, columns);
                        break;
                }
            }
            catch(Exception ex){
    ...
    //Maybe delete this tests methods
